...
export default function question(pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "Question",
		description:
			"Ask the user one or more questions with selectable options. Use when clarification or a decision is required before proceeding.",
		promptSnippet: "Ask the user one or more questions with selectable options",
		promptGuidelines: [
			"Use question when requirements are ambiguous or the user must choose between meaningful alternatives.",
		],
